...
public class ImageProcessor {
    ...
    public static void main(String[] args) {
        String inputImagePath = "F:\\college_web-main\\test\\tiles\\panorama8\\8.jpg"; // Замените на путь к вашему файлу
        try {
    ...
    public static void processImage(String inputImagePath) throws IOException {
        ...
        BufferedImage lqImage = resizeImage(originalImage, 1024, 256);
